(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.tinymce = global.tinymce || {}, global.tinymce['tinymce-angular'] = {}), global.ng.core, global.ng.common, global.ng.forms));
    ...
    ***************************************************************************** */
    ...
    var ɵ3 = uuid;
    var isTextarea = function (element) { return typeof element !== 'undefined' && element.tagName.toLowerCase() === 'textarea'; };
    var ɵ4 = isTextarea;
    ...
    var EditorComponent = /** @class */ (function (_super) {
        ...
        EditorComponent.prototype.initialise = function () {
            var _this = this;
            var finalInit = Object.assign(Object.assign({}, this.init), { target: this._element, inline: this.inline, readonly: this.disabled, plugins: mergePlugins(this.init && this.init.plugins, this.plugins), toolbar: this.toolbar || (this.init && this.init.toolbar), setup: function (editor) {
        ...
        EditorComponent.prototype.initEditor = function (editor) {
            ...
            editor.on(this.modelEvents, function () { return _this.ngZone.run(function () { return _this.emitOnChange(editor); }); });
            if (typeof this.initialValue === 'string') {
                this.ngZone.run(function () {
                    editor.setContent(_this.initialValue);
                    if (editor.getContent() !== _this.initialValue) {
                        _this.emitOnChange(editor);
                    }
        ...
        EditorComponent.prototype.emitOnChange = function (editor) {
